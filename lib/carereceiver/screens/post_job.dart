...
class _PostJobScreenState extends State<PostJobScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer2<PostedJobsProvider, RecieverUserProvider>(
      ...
      return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            if (recieverUserProvider.profileIsApprove() && recieverUserProvider.profilePerentage == 100) ...[
              TextButton(
                onPressed: () {
                                              ...
                                              ListView.builder(
                                                ...
                                                itemBuilder: (context, index) {
                                                  ...
                                                  return GestureDetector(
                                                    onTap: () {
                                                      navigationService
                                                          .push(RoutesName.serviceRecieverJobDetail, arguments: {
